export const products = [
  {
    ...
    features: [
      ...
      "Mango ergonómico con moletado de precisión",
      "Núcleo de acero forjado inastillable",
  ...
  },
  {
    ...
    features: [
      ...
      "Hasta 150 libras combinables",
      "Bolsa de transporte respirable incluida"
    ]
  },
  {
    id: 3,
    ...
    features: [
      ...
      "5.5g de BCAAs puros por porción",
      "Enzimas digestivas patentadas incluidas",
      "Materia prima certificada Grass-Fed"
    ]
  },
  {
    id: 4,
    ...
    features: [
      ...
      "Sello de pureza Creapure® certificado",
      "100 servicios netos (5g por scoop)",
      "Cero estimulantes ni añadidos sintéticos"
    ]
  },
  {
    id: 5,
    ...
    features: [
      ...
      "No produce 'Crash' ni dolor de cabeza",
      "3.2g de Beta-Alanina para resistencia",
      "Sabor explosivo a Frutos Rojos"
    ]
  },
  {
    id: 6,
    ...
    features: [
      ...
      "Tecnología térmica de compresión muscular",
      "Tratamiento anti-olor y antibacterial",
      "Costuras reforzadas e invisibles"
    ]
  },
  {
    id: 7,
    ...
    features: [
      ...
      "Hebilla de acero forjado de liberación rápida",
      "Grosor constante de 10mm en todo su perímetro",
      "Avalada por federaciones de Powerlifting"
    ]
  },
  {
    id: 8,
    ...
    features: [
      ...
      "Tapa de tritán grueso y seguro antiderrame",
      "Rejilla mezcladora metálica silenciosa",
